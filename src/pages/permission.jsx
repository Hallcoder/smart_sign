...
function Permisssion() {
    return (  
        <div>
            <NavBar/>
            <div className='w-8/12 mt-24 min-h-fit border-2 m-auto'>
            ...
            <form method="post"  className='w-11/12 m-auto mt-10 p-2 flex-col flex'>
                    ...
                    <select name="departureReason" id="reason" className='h-14 w-6/12 text-xl bg-white border focus:outline-none rounded-md border'>
                    ...
                    <Input type="time" label="Departure time" name={"departureDate"}/>
                    <Input type="date" label="Expected return date" name={"departureDate"}/>
                    <Input type="time" label="Expected return  time" name={"departureDate"}/>
                    <label htmlFor="reason" className='font-bold text-lg'>Issuer:</label><br />
                    <select name="departureReason" id="reason" className='h-14 text-xl w-6/12 bg-white border focus:outline-none rounded-md border'>
